import {neighborhoods} from '../../../consts'
export async function getStaticPaths() {
    return neighborhoods.map(n=>({
        params: {neighborhood: n}
    }))
}

export const { neighborhood } = Astro.props;

**Bienvenido a ArmadoresMontevideo**, tu solución confiable para el armado de muebles a domicilio en {neighborhood}. Nos especializamos en ofrecer un servicio profesional y eficiente para asegurar que tus muebles queden perfectamente ensamblados y listos para usar.
